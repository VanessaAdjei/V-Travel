...
<div class="container">
  <div class="jumbotron" style="text-align: center;">
      <h2> <?php echo "Yay!" ?> </h2>
      <h1>You have submitted your available date for an interview.</h1>
      <p>You can go back to home here. Kindly wait for an email from us <a href="homepage.php">HERE</a></p>
  </div>
</div>
